...
// TAREA 1: Función para identificar a los estudiantes que necesitan tutoría (promedio menor a 75)
function estudiantesNecesitanTutoria($estudiantes) {
 ...
 // TAREA 2: Función para listar a los estudiantes de honor (promedio 90 o más)
 ...
 if (!empty($tutoria)) {
    ...
    echo implode(", ", $tutoria) . "\n";
 } else {
    echo "\nNo hay estudiantes que necesiten tutoría.\n";
 }
