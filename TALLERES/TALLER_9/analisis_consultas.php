...
$consultas = [
    ...
    "
    "Consulta por nombre y stock" => "
        SELECT * FROM productos WHERE nombre LIKE '%Laptop%' AND stock > 0
    ",
    "Consulta por cliente y estado" => "
        SELECT * FROM ventas WHERE cliente_id = 1 AND estado = 'completada'
    ",
    "Detalles de venta por producto" => "
        SELECT * FROM detalles_venta WHERE producto_id = 2
    "
];
